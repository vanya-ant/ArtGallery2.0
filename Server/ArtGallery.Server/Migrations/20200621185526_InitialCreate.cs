    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistItems", x => new { x.ArtistId, x.ItemId });
                    table.ForeignKey(
                        name: "FK_ArtistItems_Attists_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Attists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArtistItems_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtistItems_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtistItems_ItemId",
                table: "ArtistItems",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ArtistItems_OrderId",
                table: "ArtistItems",
                column: "OrderId");
